...
export class TruliooJobHandler {
  constructor(private db = new TruliooJobRepository(new PrismaClient())) {
  ...
  async filterData(
    jobData: Prisma.TruliooJobCreateInput[]
  ...
  static async run() {
    const handler = new TruliooJobHandler();
...
// TruliooJobHandler.run().then((res) => {
